...
const Cards = ({ superhero }) => {
  ...
  return (
    <div className="card">
      ...
      <img className="image" src={superhero.url} alt={superhero.name} /> 
    </div>
  );  
} 
*/

const Cards = ({ name, universe, alterego, occupation, friends, superpowers, url }) => {
...
return (
    <div className="cards-container">
      {superheroes.map((hero, index) => (
        <Cards key={index} superhero={hero} />
        )
      )
    }
    </div>
